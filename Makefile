...
CFLAGS = -m32 -fno-stack-protector -fno-builtin -Wall
BUILD = build
...
image:
	ld -m elf_i386 -T linker.ld -o SB/boot/kernel $(BUILD)/boot.o $(BUILD)/kernel.o $(BUILD)/vga.o $(BUILD)/gdt.o $(BUILD)/gdts.o
